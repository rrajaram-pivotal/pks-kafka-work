...
public class Customer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<io.pivotal.workshops.pkskafka.inventory.domain.events.CustomerAddress> customerAddress;
   ...
   */
  public Customer(java.lang.CharSequence firstName, java.lang.CharSequence lastName, java.lang.Boolean automatedEmail, java.util.List<java.lang.CharSequence> customerEmails, java.util.List<io.pivotal.workshops.pkskafka.inventory.domain.events.CustomerAddress> customerAddress) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: customerAddress = (java.util.List<io.pivotal.workshops.pkskafka.inventory.domain.events.CustomerAddress>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<io.pivotal.workshops.pkskafka.inventory.domain.events.CustomerAddress> getCustomerAddress() {
   ...
   * @param value the value to set.
   */
  public void setCustomerAddress(java.util.List<io.pivotal.workshops.pkskafka.inventory.domain.events.CustomerAddress> value) {
   ...
   */
  public static io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder newBuilder() {
    return new io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder();
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder newBuilder(io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder other) {
    return new io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder(other);
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder newBuilder(io.pivotal.workshops.pkskafka.inventory.domain.events.Customer other) {
    return new io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Customer>
    ...
    /** Complex Type - Refer Customer Address */
    private java.util.List<io.pivotal.workshops.pkskafka.inventory.domain.events.CustomerAddress> customerAddress;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.inventory.domain.events.Customer other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder setAutomatedEmail(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder clearAutomatedEmail() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder setCustomerEmails(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder clearCustomerEmails() {
      customerEmails = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder setCustomerAddress(java.util.List<io.pivotal.workshops.pkskafka.inventory.domain.events.CustomerAddress> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.Customer.Builder clearCustomerAddress() {
    ...
    public Customer build() {
      try {
        ...
        record.customerAddress = fieldSetFlags()[4] ? this.customerAddress : (java.util.List<io.pivotal.workshops.pkskafka.inventory.domain.events.CustomerAddress>) defaultValue(fields()[4]);
        return record;
