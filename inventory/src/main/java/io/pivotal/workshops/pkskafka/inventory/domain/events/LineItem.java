...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItemState state;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: state = (io.pivotal.workshops.pkskafka.inventory.domain.events.LineItemState)value$; break;
   ...
   */
  public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItemState getState() {
    return state;
  }
   ...
   * @param value the value to set.
   */
  public void setState(io.pivotal.workshops.pkskafka.inventory.domain.events.LineItemState value) {
    this.state = value;
  }
   ...
   */
  public static io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder newBuilder() {
    return new io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder newBuilder(io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder other) {
    return new io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder(other);
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder newBuilder(io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem other) {
    return new io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
    ...
    private io.pivotal.workshops.pkskafka.inventory.domain.events.LineItemState state;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.sku)) {
        this.sku = data().deepCopy(fields()[0].schema(), other.sku);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setSku(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearSku() {
      sku = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setLineNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearLineNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setState(io.pivotal.workshops.pkskafka.inventory.domain.events.LineItemState value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setOriginalPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearOriginalPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setDiscount(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearDiscount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setPurchasePrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearPurchasePrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setEstimatedUnitTax(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearEstimatedUnitTax() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setUpc(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearUpc() {
      upc = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder setEstimatedDeliveryDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.inventory.domain.events.LineItem.Builder clearEstimatedDeliveryDate() {
    ...
    public LineItem build() {
      try {
        ...
        record.state = fieldSetFlags()[2] ? this.state : (io.pivotal.workshops.pkskafka.inventory.domain.events.LineItemState) defaultValue(fields()[2]);
