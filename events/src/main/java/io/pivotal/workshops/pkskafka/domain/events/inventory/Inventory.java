 ...
 */
package io.pivotal.workshops.pkskafka.domain.events.inventory;
...
public class Inventory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2501867203769612002L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Inventory\",\"namespace\":\"io.pivotal.workshops.pkskafka.domain.events.inventory\",\"fields\":[{\"name\":\"sku\",\"type\":\"string\",\"doc\":\"Sku of the product\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder newBuilder() {
    return new io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder();
  }
   ...
   * @return A new Inventory RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder newBuilder(io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder other) {
    return new io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder(other);
  }
   ...
   * @return A new Inventory RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder newBuilder(io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory other) {
    return new io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Inventory>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.sku)) {
        this.sku = data().deepCopy(fields()[0].schema(), other.sku);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder setSku(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder clearSku() {
      sku = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.domain.events.inventory.Inventory.Builder clearQuantity() {
