...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public io.pivotal.workshops.pkskafka.domain.events.order.LineItemState getState() {
    return state;
  }
   ...
   * @param value the value to set.
   */
  public void setState(io.pivotal.workshops.pkskafka.domain.events.order.LineItemState value) {
    this.state = value;
  }
   ...
   */
  public static io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder newBuilder() {
    return new io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder newBuilder(io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder other) {
    return new io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder(other);
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder newBuilder(io.pivotal.workshops.pkskafka.domain.events.order.LineItem other) {
    return new io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.domain.events.order.LineItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.sku)) {
        this.sku = data().deepCopy(fields()[0].schema(), other.sku);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder setSku(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.domain.events.order.LineItem.Builder clearSku() {
      sku = null;
