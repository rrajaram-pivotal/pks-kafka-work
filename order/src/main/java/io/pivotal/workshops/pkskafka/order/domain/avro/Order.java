...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5048955928646788747L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"io.pivotal.order.model.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"customerId\",\"type\":\"long\"},{\"name\":\"state\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"double\"}]}");
   ...
   */
  public Order(java.lang.CharSequence id, java.lang.Long customerId, java.lang.CharSequence state, java.lang.CharSequence product, java.lang.Integer quantity, java.lang.Double price) {
    this.id = id;
   ...
   */
  public static io.pivotal.order.model.avro.Order.Builder newBuilder() {
    return new io.pivotal.order.model.avro.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static io.pivotal.order.model.avro.Order.Builder newBuilder(io.pivotal.order.model.avro.Order.Builder other) {
    return new io.pivotal.order.model.avro.Order.Builder(other);
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static io.pivotal.order.model.avro.Order.Builder newBuilder(io.pivotal.order.model.avro.Order other) {
    return new io.pivotal.order.model.avro.Order.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pivotal.order.model.avro.Order.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pivotal.order.model.avro.Order other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder setCustomerId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder clearCustomerId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.Order.Builder clearPrice() {
