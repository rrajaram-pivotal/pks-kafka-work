...
public class CustomerAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5300393240107547512L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerAddress\",\"namespace\":\"io.pivotal.workshops.pkskafka.order.domain.events\",\"fields\":[{\"name\":\"address\",\"type\":\"string\",\"doc\":\"Address Line 1\"},{\"name\":\"city\",\"type\":\"string\"},{\"name\":\"state\",\"type\":\"string\"},{\"name\":\"zipcode\",\"type\":[\"string\",\"int\"]}]}");
   ...
   */
  public static io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder newBuilder() {
    return new io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder();
  }
   ...
   * @return A new CustomerAddress RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder newBuilder(io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder other) {
    return new io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder(other);
  }
   ...
   * @return A new CustomerAddress RecordBuilder
   */
  public static io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder newBuilder(io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress other) {
    return new io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder setZipcode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.workshops.pkskafka.order.domain.events.CustomerAddress.Builder clearZipcode() {
      zipcode = null;
