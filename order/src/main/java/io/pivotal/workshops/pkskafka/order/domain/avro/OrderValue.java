...
public class OrderValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4666708779936223218L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderValue\",\"namespace\":\"io.pivotal.order.model.avro\",\"fields\":[{\"name\":\"order\",\"type\":{\"type\":\"record\",\"name\":\"Order\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"customerId\",\"type\":\"long\"},{\"name\":\"state\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"double\"}]}},{\"name\":\"value\",\"type\":\"double\"}]}");
  ...
  @Deprecated public io.pivotal.order.model.avro.Order order;
   ...
   */
  public OrderValue(io.pivotal.order.model.avro.Order order, java.lang.Double value) {
    this.order = order;
    this.value = value;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: order = (io.pivotal.order.model.avro.Order)value$; break;
   ...
   */
  public io.pivotal.order.model.avro.Order getOrder() {
    return order;
  }
   ...
   */
  public void setOrder(io.pivotal.order.model.avro.Order value) {
    this.order = value;
  }
   ...
   */
  public static io.pivotal.order.model.avro.OrderValue.Builder newBuilder() {
    return new io.pivotal.order.model.avro.OrderValue.Builder();
  }
   ...
   * @return A new OrderValue RecordBuilder
   */
  public static io.pivotal.order.model.avro.OrderValue.Builder newBuilder(io.pivotal.order.model.avro.OrderValue.Builder other) {
    return new io.pivotal.order.model.avro.OrderValue.Builder(other);
  }
   ...
   * @return A new OrderValue RecordBuilder
   */
  public static io.pivotal.order.model.avro.OrderValue.Builder newBuilder(io.pivotal.order.model.avro.OrderValue other) {
    return new io.pivotal.order.model.avro.OrderValue.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderValue>
    ...
    private io.pivotal.order.model.avro.Order order;
    private io.pivotal.order.model.avro.Order.Builder orderBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pivotal.order.model.avro.OrderValue.Builder other) {
      super(other);
      ...
      if (other.hasOrderBuilder()) {
        this.orderBuilder = io.pivotal.order.model.avro.Order.newBuilder(other.getOrderBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pivotal.order.model.avro.OrderValue other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.order)) {
        this.order = data().deepCopy(fields()[0].schema(), other.order);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.OrderValue.Builder setOrder(io.pivotal.order.model.avro.Order value) {
     ...
     * @return This builder.
     */
    public io.pivotal.order.model.avro.Order.Builder getOrderBuilder() {
      if (orderBuilder == null) {
        if (hasOrder()) {
          setOrderBuilder(io.pivotal.order.model.avro.Order.newBuilder(order));
        } else {
          setOrderBuilder(io.pivotal.order.model.avro.Order.newBuilder());
        }
      }
      return orderBuilder;
    }
     ...
     * @return This builder.
     */
    public io.pivotal.order.model.avro.OrderValue.Builder setOrderBuilder(io.pivotal.order.model.avro.Order.Builder value) {
      clearOrder();
      orderBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.OrderValue.Builder clearOrder() {
      order = null;
      orderBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.OrderValue.Builder setValue(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pivotal.order.model.avro.OrderValue.Builder clearValue() {
    ...
    public OrderValue build() {
      try {
        ...
        if (orderBuilder != null) {
          ...
          record.order = fieldSetFlags()[0] ? this.order : (io.pivotal.order.model.avro.Order) defaultValue(fields()[0]);
        }
